...
void quicksort(neutron *, int, int);
int partition(neutron *, int, int);
int random_partition(neutron *, int, int);
void swap(neutron *, neutron *);

void remove_negative_weight(neutron **);
