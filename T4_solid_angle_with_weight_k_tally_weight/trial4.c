...
int main() {
    ...
    const char *input = "input_4.txt"; // File for reading the inputs
    const char *filename1 = "flux_data_4.txt"; // File for storing neutron flux data
    const char *filename2 = "text_data_4.txt"; // File for storing data of each cycle
    const char *filename3 = "position_data_4.txt"; // File for storing neutron position data
    const char *filename4 = "reweight_data_4.txt"; // File for storing reweighted neutron data
    ...
    for(int i = 0; i < M; i++) {
        ...
        reweight_neutrons(file4, child_fission_bank_double_pointer);
