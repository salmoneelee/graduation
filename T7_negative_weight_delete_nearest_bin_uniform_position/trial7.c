...
int main() {
    ...
    const char *input = "input_7.txt"; // File for reading the inputs
    const char *filename1 = "flux_data_7.txt"; // File for storing neutron flux data
    const char *filename2 = "text_data_7.txt"; // File for storing data of each cycle
    const char *filename3 = "position_data_7.txt"; // File for storing neutron position data
    const char *filename4 = "remove_data_7.txt"; // File for storing neutron data related to removal
